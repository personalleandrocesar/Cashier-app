...
<template>
    <div>
        ...
        <div class="inputs">
            <div>
                <span>Nome do Item</span> <input class="inputs" v-model="newItem.name" />
            </div>
            <div>
                <span>Valor unitário</span> <input class="inputs" v-model.number="newItem.price" type="number" />
            </div>
        </div>
        <div class="inputs">
            <div>
                <span>Quantidades</span> <input class="inputs" v-model.number="newItem.quantity" type="number" />
            </div>
            <div>
                <span>Método de pagamento</span>
                <select v-model="newItem.paymentMethod">
